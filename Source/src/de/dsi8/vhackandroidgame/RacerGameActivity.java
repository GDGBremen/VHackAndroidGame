...
public class RacerGameActivity extends SimpleBaseGameActivity implements
		IGameCoordinatorLogicListener, IGamePresentationLogicListener,
		ContactListener {
	// ===========================================================
	// Constants
	// ===========================================================
...
InternalConnector connector = new InternalConnector();
		...
		this.serverLogic = new GameCoordinatorLogic(this, connector.getFirstConnection());
		this.serverLogic.start();
		
		presentationLogic = new GamePresentationLogic(RacerGameActivity.this, connector.getSecondConnection());
	...
	public void addObstacle(final float pX, final float pY) {
		final Sprite box = new Sprite(pX, pY, OBSTACLE_SIZE, OBSTACLE_SIZE,
				this.mBoxTextureRegion, this.getVertexBufferObjectManager());
